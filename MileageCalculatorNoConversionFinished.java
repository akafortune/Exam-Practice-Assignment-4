 ...
 * Description: updated milage calculator with combobox functionality 
 */
package ch16;
...
public class MileageCalculatorNoConversionFinished extends Application {
    ...
    private ComboBox<String> unitSelection = new ComboBox<>();
    
    private String unitTypes[] = {defaultResult, altResult};
    ...
    public void start(Stage primaryStage) {   	
    	...
    	unitSelection.setItems(FXCollections.observableArrayList(unitTypes));
        ...
        mainPane.add(unitSelection, 1, 0);
        ...
        unitSelection.setOnAction(e -> changeLabels());
    ...
    private void changeLabels() {
    	...
    	if ( unitSelection.getValue() == altResult && lblCapacity.getText().equals(defaultCapacity)) {
        	// update labels
    ...
    private void calcMileage() {       
        ...
        double result = 0.0;
        if (unitSelection.getValue() == altResult) {
        	// liters / 100KM
    ...
    private void resetForm() {
    	...
    	unitSelection.setValue(defaultResult);
